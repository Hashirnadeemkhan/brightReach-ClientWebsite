    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
         At brightreachsolutions, we are committed to providing transparent, ethical, and high-quality digital services. Due to the nature of our work, the following cancellation and refund policy applies.
        </p>
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-700 mb-4">
            brightreachsolutions strictly follows White Hat SEO techniques that comply with search engine guidelines, ensuring long-term success and protection from penalties.
          </p>
          <p className="text-gray-700 mb-6">
            No refund will be provided if the client ignores or overrides brightreachsolutions SEO recommendations or implementation strategies, including but not limited to:
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
